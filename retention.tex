...
while ignoring whether that uncertainty can change the next box.
...
The closest off-the-shelf method loses as well. Sequential OCBA-m,
which re-splits the remaining budget across items after each answer,
trails the guarded rule at every budget under both priors, \(0.112\)
against \(0.027\) at \(30L\) under the independent prior
(Appendix Table~\ref{tab:ocba}). It targets asymptotic
