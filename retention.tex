...
item eventually. In the independent-prior benchmark at
experimental scale, the guarded rule also achieves a lower mean gap
than the best static allocation found by direct optimization at every
budget, with the largest paired margin at the tight budget
(Appendix~\ref{app:greedy-optimal}).
